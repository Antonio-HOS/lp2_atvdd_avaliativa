//Em sala de aula analisamos uma versão recursiva para calcular a soma dos elementos de uma array.
//Faça uma versão recursiva da função que implementa o cálculo da média dos elementos de um array.
